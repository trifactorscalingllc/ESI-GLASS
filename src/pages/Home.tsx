    ...
    <section className="relative h-[100svh] min-h-[640px] w-full bg-night text-night-fg">
      ...
      <div className="absolute inset-0">
        <img
          ...
          className="h-full w-full object-cover opacity-70 animate-fade-in"
          loading="eager"
        />
      ...
      <div className="container-x relative flex h-full flex-col justify-end pb-16 pt-32 md:pb-24">
        <div className="grid gap-12 md:grid-cols-12 md:items-end">
          ...
          <div className="md:col-span-4 md:pl-6 md:border-l md:border-white/15">
            <Reveal variant="fade-up" delay={350} duration={1100}>
            ...
            <Reveal variant="fade-up" delay={500} duration={1000}>
              <div className="mt-8 flex flex-col gap-3 sm:flex-row md:flex-col">
                <Button
                  ...
                  variant="secondary"
                  size="lg"
                  className="ed-cta rounded-none font-mono text-[11px] uppercase tracking-[0.18em]"
                >
                  <Link to="/contact">
                ...
                <Button
                  ...
                  variant="link"
                  size="lg"
                  className="ed-cta rounded-none px-0 font-mono text-[11px] uppercase tracking-[0.18em] text-white/80"
                >
                  <Link to="/work" className="link-underline">
                    View selected work
                    <ArrowUpRight className="ed-cta-arrow ml-1 h-4 w-4" />
                  </Link>
                </Button>
              </div>
            </Reveal>
      ...
      <div className="absolute inset-x-0 bottom-0 border-t border-white/10">
        <div className="container-x flex h-12 items-center justify-between font-mono text-[10px] uppercase tracking-[0.18em] text-white/50">
          <span className="ed-scroll-cue inline-flex items-center gap-2">
            <span className="ed-scroll-line block h-px w-6 bg-white/40" />
            Scroll
          </span>
      ...
      <div className="container-x">
          ...
          <div className="md:col-span-7 md:col-start-6">
            <Reveal variant="fade-in" delay={250}>
              <p className="lede">
                ...
                the specialty interior elements that finish a space. Every
                scope is engineered, drafted, fabricated, and installed under
                one roof.
              </p>
            </Reveal>
            <Reveal variant="fade-up" delay={350}>
              ...
              >
                All capabilities <ArrowUpRight className="ed-cta-arrow h-3.5 w-3.5" />
              </Link>
            </Reveal>
          </div>
        </div>
        ...
        <Stagger step={90} initialDelay={120}>
          {services.map((service, idx) => (
            <Reveal key={service.slug} variant="fade-up" distance={20}>
              <Link
                to={`/services#${service.slug}`}
                className="ed-row group grid grid-cols-12 items-center gap-6 border-b border-ink/15 py-8 md:py-10"
              >
  ...
  return (
    <section className="bg-paper-2 py-24 md:py-36">
      <div className="container-x">
        ...
        <Stagger step={120} initialDelay={150}>
            ...
            {projectCategories.map((cat, idx) => {
              ...
              return (
                <Reveal
                  ...
                  distance={32}
                >
                  <Link to={`/work#${cat.slug}`} className="group block">
                    <div className={`ed-card-photo relative ${aspect} w-full`}>
                      <img
                        src={cat.image}
                        alt={cat.title}
                    ...
                    <div className="mt-5 flex items-start justify-between gap-6">
                      <div>
                        <div className="ed-marker font-mono text-[10px] uppercase tracking-[0.18em] text-ink-3">
                          / 0{idx + 1} — {cat.featured}
                        </div>
                        <h3 className="font-display text-2xl mt-2 md:text-3xl">
                          <span className="link-draw">{cat.title}</span>
                        </h3>
                      </div>
                      <ArrowUpRight className="ed-cta-arrow mt-1 h-5 w-5 flex-shrink-0 text-ink-3 transition-colors group-hover:text-ink" />
                    </div>
                  </Link>
                </Reveal>
              );
        ...
        <Reveal variant="fade-up" className="mt-16 flex justify-end">
          ...
          >
            All work <ArrowUpRight className="ed-cta-arrow h-3.5 w-3.5" />
          </Link>
        </Reveal>
      </div>
    </section>
      ...
      <div className="container-x">
        <div className="grid gap-10 md:grid-cols-12 md:gap-16">
          ...
          <div className="md:col-span-7 md:col-start-6">
            <Reveal variant="fade-in" delay={250}>
              <p className="lede">
                We've built our business on a long list of architects, GCs,
                and owners who keep coming back — because what we promise on
                paper is what shows up on site.
              </p>
            </Reveal>
          </div>
        </div>
      ...
      <div className="container-x">
          ...
          <div className="md:col-span-7 md:col-start-6">
            <Reveal variant="fade-in" delay={250}>
              <p className="lede text-white/70">
                ...
                before a single panel is fabricated. The disciplined process
                is why our drawings, samples, and field crews behave like one
                continuous team.
              </p>
            </Reveal>
          </div>
        ...
        <Stagger step={120} initialDelay={150}>
          <div className="mt-20 grid gap-px border border-white/10 bg-white/10 sm:grid-cols-2 md:grid-cols-4">
            {steps.map((s) => (
              <Reveal key={s.n} variant="fade-up" distance={20}>
                <div className="group bg-night p-8 md:p-10 transition-colors duration-500 hover:bg-night-2">
            ...
            <Reveal variant="fade-up" delay={400}>
              <div className="mt-8 flex flex-col gap-4">
                <Button
                  asChild
                  size="lg"
                  className="ed-cta w-full rounded-none font-mono text-[11px] uppercase tracking-[0.18em] sm:w-auto sm:self-start"
                >
                  <Link to="/contact">
                    Start a project
                    <ArrowRight className="ed-cta-arrow ml-2 h-4 w-4" />
